...
export default function Modal({open}: Props){
    ...
    return (
        <div className={`w-full h-full fixed transition-colors flex justify-center z-30 ${open ? "visible bg-black/70" : "invisible"}`}>
            <div className={`absolute w-[950px] h-[850px] top-[3em] overflow-hidden rounded-lg bg-[#181818] shadow transition-all ${open ? "scale-100 opacity-100" : "scale-50 opacity-0"}`}>
                ...
                <div className="flex space-x-16 rounded-b-md bg-[#181818] px-10 p-6">
                    <div className="space-y-8 text-lg">
                        ...
                        <div className="flex flex-col justify-between pr-8 gap-y-4 font-normal md:flex-row">
